...
async function auth(r, afterSyncCheck) {
    ...
    await storeSessionData(r, tokenset, false);
...
async function codeExchange(r) {
    ...
    await storeSessionData(r, tokenset, true);
...
async function getTokenClaims(r, token) {
...
async function storeSessionData(r, tokenset, isNewSession) {
    if (isNewSession) {
